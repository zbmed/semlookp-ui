...
export const ts_specific_metadata = {
  ...
  collection: "", // not important now, will be relevant in the future for the widgets that are using the TS4NFDI Gateway
  homepage: {
    has_logo: true,
    ...
    project_intro_title: "Terminology Service Plasma-MDS",
