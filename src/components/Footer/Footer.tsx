...
import { ReactComponent as NfdiLogo } from "../Layout/logos/NFDI4Health_Logo_cmyk_RZ.svg";
  ...
  return (
      <div>
        ...
        <EuiFlexGroup justifyContent="spaceAround" gutterSize="xl">
          <EuiFlexItem grow={false}>
            <EuiText color="subdued" size="s">
              This service is developed in the project NFDI4Health which is one of the funded consortia of the National Research Data Infrastructure programme of the DFG. (Project identifier 442326535).
            </EuiText>
          </EuiFlexItem>
        </EuiFlexGroup>
      </div>
