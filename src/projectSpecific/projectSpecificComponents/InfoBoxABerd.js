    ...
    <>
      <EuiText>
        <EuiLink href="https://www.berd-nfdi.de/">
          <EuiImage size="original" src={logo} alt={"InfoBoxALogo"} />
        </EuiLink>
        <br></br>
        <EuiSpacer size="s" />
        <div style={{ textAlign: "center" }}>
          <EuiLink href={"https://www.berd-nfdi.de/"}> BERD@NFDI </EuiLink>
          is a Central Resource for Unstructured Data Related to Business,
          Economics, and similar Social Sciences.
        </div>
      </EuiText>
    </>
  );
